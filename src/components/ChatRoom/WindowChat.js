...
export default function WindowChat() {
  return (
    <div>
      <div className="flex flex justify-between px-4 py-[8.5px] border-b-[1px]">
        <div className="">
          <p className="text-[14px] font-bold">Room 1</p>
          <p className="text-[12px]">Đây là room 1</p>
        </div>
        <div className="flex items-center">
          <button className="flex items-center">
            ...
            <p className="text-[14px] ml-[8px]">Mời</p>
          </button>
          <div className="flex ml-[16px]">
            <span className="overflow-hidden ml-[-8px] ">
              <img
            ...
            <span className="overflow-hidden ml-[-8px] ">
              <img
                className="w-[24px] h-[24px] rounded-[50%] object-cover"
                src="https://lh3.googleusercontent.com/a-/AOh14GiXH08XHXauozNXvu34YDjwjFxo0M9vwJVxW1FYeA=s96-c"
                alt="avatar"
              />
            </span>
            <span className="overflow-hidden ml-[-8px]">
              <div className="w-[24px] h-[24px] bg-[#ccc] rounded-[50%] text-[white] flex items-center justify-center text-[12px]">
                +1
              </div>
            </span>
          </div>
